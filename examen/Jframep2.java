...
private float p;
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(24, 24, 24)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(fdescuento, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(fmembresia, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cedula", "Nombre", "Ciudad", "sexo", "Correo", "Teléfono", "Fecha de Nacimiento", "Provincia", "Corregimiento", "Membresia", "Descuento", "Promedio compras"
            }
        ));
        ...
        jButton6.setText("Conexión en archivo txt");
...
try {
    ...
    PreparedStatement ps = con.prepareStatement("INSERT INTO ClienteF(cedula, nombre, ciudad, sexo, correo, telefono, nacimiento, provincia, corregimiento, membresia, descuento, promedio) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
    ...
    ps.setFloat(12, promedioCompras);
    ps.executeUpdate();
...
public void limpiar(){
    ...
    private void beliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beliminarActionPerformed
        ...
        try{
            Connection con = Conexionn.getConnection();
            PreparedStatement ps = con.prepareStatement("delete from clienteF where cedula = ?");
            ps.setString(1, cedula);
            ps.executeUpdate();
    ...
    private void bmodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bmodActionPerformed
        ...
        try{
            Connection con = Conexionn.getConnection();
            PreparedStatement ps = con.prepareStatement("update ClienteF set nombre=?, ciudad=?, sexo=?, correo=?, telefono=?, nacimiento=?, provincia=?, corregimiento=?,membresia=?, descuento=?, promedio=? where cedula = ?");
 ...
 public void cargartabla(){
        DefaultTableModel modelotabla= (DefaultTableModel) jTable1.getModel();
          ...
          try{
               Connection con = Conexionn.getConnection();
               ps = con.prepareStatement("select cedula, nombre, ciudad, sexo, correo, telefono, nacimiento, provincia, corregimiento, membresia, descuento, promedio from clienteF");
               rs = ps.executeQuery();
               rsmd = rs.getMetaData();
...
try{
          ...
          String cedula = jTable1.getValueAt(fila, 0).toString();
            Connection con = Conexionn.getConnection();
              PreparedStatement ps;
              ResultSet rs;
              ps = con.prepareStatement("select cedula, nombre, ciudad,sexo, correo, telefono, nacimiento, provincia, corregimiento, membresia, descuento from clienteF where cedula = ?");
              ps.setString(1, cedula);
              rs =ps.executeQuery();
